                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active carousel-item-left"> <img className="d-block w-100" src={banner1} alt="First slide"></img>
                            <div className="carousel-caption d-none d-md-block">
                                <h5>Best mountain bike seller. Come and get yours</h5><button className="btn btn-primary">View Ad</button>
                            </div>
                        </div>
                        <div className="carousel-item carousel-item-next carousel-item-left"> <img className="d-block w-100" src={banner2} alt="Second slide"></img>
                            <div className="carousel-caption d-none d-md-block">
                                <header className="header text-center text-lg">Yaana Waahana Niwasa pvt.(ltd)</header>
                                <h5>Your dream Car is here.</h5><a href="/Search" className="btn btn-primary">View Ad</a>
                            </div>
                        </div>
                        <div className="carousel-item"> <img className="d-block w-100" src={banner3} alt="Third slide" ></img>
                            <div className="carousel-caption d-none d-md-block">
                                <header className="header text-primary text-center">Prime Homes</header>
                                ...
                                <a href="#" className="btn btn-primary">View Ad</a>
                            </div>
                        </div>
                        ...
                        <div className="carousel-item"> <img className="d-block w-100" src={banner5} alt="Fifth slide"></img>
                            <div className="carousel-caption d-none d-md-block">
                                <header className="header text-primary text-center">I store</header>
                        ...
                        <div className="carousel-item"> <img className="d-block w-100" src={banner7} alt="Seventh slide"></img>
                            <div className="carousel-caption d-none d-md-block">
                                <header className="header text-primary text-center">Laptop Store</header>
